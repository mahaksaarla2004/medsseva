...
import { getAllBookings, createBooking, updateBookingStatus, createRazorpayOrder, updatePaymentStatus, assignExecutive, generatePaymentLink, checkPaymentLinkStatus, collectSample, getAvailableSlots } from '../controllers/bookingController';
...
router.get('/available-slots', getAvailableSlots); // Public — no auth needed for slot checking
